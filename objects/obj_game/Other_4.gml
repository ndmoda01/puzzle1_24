...
switch(room){
	...
	case rm_2P_level_CC_1: scr_level_start(_level_timer,_spawn_timer,45,3,3,[1,2,3],.7,false);    break;
	case rm_2P_level_CC_2: scr_level_start(_level_timer,_spawn_timer,45,3,3,[1,2,3],.7,false);    break;
	case rm_2P_level_CC_3: scr_level_start(_level_timer,_spawn_timer,45,3,3,[1,2,3],.7,false);    break;
