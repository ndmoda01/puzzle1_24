...
switch(room){
	...
	case rm_2P_level_CC_2: scr_level_start(_level_timer,_spawn_timer,28,3,3,[2,3,4,5],.7,false);    break;
	case rm_2P_level_CC_3: scr_level_start(_level_timer,_spawn_timer,20,3,3,[1,2,4,5],.7,false);    break;
